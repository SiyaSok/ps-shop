...
const ProductPageFooter = () => {
  return (
    <div className='bg-orange-100 p-8  mt-10'>
      <div className='container py-6 mx-auto'>
        <div className='flex flex-col items-start  md:items-center gap-4 justify-around md:flex-row'>
          <div className='flex items-center gap-4'>
            <AiOutlineTrophy className='text-4xl md:text-6xl' />
            <div className='flex iteams-center flex-col'>
